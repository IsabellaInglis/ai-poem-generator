...
function generatePoem(event) {
  ...
  let prompt = `Write me a short poem about ${topic.value},that is 2-4 lines long. The poem must be provided in the following HTML format: "<div>Poem line 1<br>Poem line 2<br>Poem line 3<br>Poem line 4</div>`;
